...
public class UnidirectionalFlow {
	...
	private FlowRule fwdFlowRule;
	private FlowRule bwdFlowRule;
	...
	public UnidirectionalFlow(FlowDetails forwardFlow, FlowDetails backwardFlow, double flowBytesPerSecond,
			...
			FlowRule fwdFlowRule, FlowRule bwdFlowRule) {
		...
		this.fwdFlowRule = fwdFlowRule;
		this.bwdFlowRule = bwdFlowRule;
	...
	public FlowRule getFwdFlowRule() {
		return fwdFlowRule;
	}

	public void setFwdFlowRule(FlowRule fwdFlowRule) {
		this.fwdFlowRule = fwdFlowRule;
	}

	public FlowRule getBwdFlowRule() {
		return bwdFlowRule;
	}


	public void setBwdFlowRule(FlowRule bwdFlowRule) {
		this.bwdFlowRule = bwdFlowRule;
	}
