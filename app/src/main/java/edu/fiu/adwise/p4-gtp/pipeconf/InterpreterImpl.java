...
package edu.fiu.adwise.p4-gtp.pipeconf;
...
import static edu.fiu.adwise.p4-gtp.AppConstants.CPU_PORT_ID;
...
import edu.fiu.adwise.p4-gtp.MainComponent;
import edu.fiu.adwise.p4-gtp.common.Utils;
...
public class InterpreterImpl extends AbstractHandlerBehaviour
    ...
    //private ApplicationId appId = mainComponent.getAppId();
