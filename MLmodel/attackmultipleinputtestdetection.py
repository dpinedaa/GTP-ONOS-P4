...
try:
    with open(file_path, 'r', newline='') as csvfile:
        ...
        accuracy_logistic_regression = total_correct_logistic_regression / len(attack_random_rows)
        accuracy_knearest_neighbours = total_correct_knearest_neighbours / len(attack_random_rows)
        accuracy_naive_bayes = total_correct_naive_bayes / len(attack_random_rows)
        accuracy_random_forest = total_correct_random_forest / len(attack_random_rows)
