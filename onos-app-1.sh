...
while true; do
    ...
    echo "5.- upload-onos-app (Upload ONOS app)"
    ...
    case "$choice" in
        ...
        *"4"* | *"compile-onos-app"* | *"compile"*"onos"*"app"* | *"onos"*"app"*"compile"* | *"compile"*"app"*"onos"*)
            ...
            ;;
        *"5"* | *"upload-onos-app"* | *"upload"*"onos"*"app"* | *"onos"*"app"*"upload"* | *"upload"*"app"*"onos"*)
            echo "You chose to upload ONOS app."
            ;;
        *"6"* | *"exit"* )
            echo "You chose to exit the script."
            exit 0
            ;;
        *)
