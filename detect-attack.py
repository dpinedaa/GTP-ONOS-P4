...
# Define attack CSV file path
attack_csv_path = 'attack_data.csv'

# Check if the CSV file exists, if not, create it with headers
if not os.path.exists(attack_csv_path):
    with open(attack_csv_path, 'w', newline='') as attack_file:
        writer = csv.writer(attack_file)
        writer.writerow(['Protocol', 'Flow Duration', 'Total Fwd Packets', 'Total Backward Packets',
                         'Total Length of Fwd Packets', 'Total Length of Bwd Packets',
                         'Flow Bytes/s', 'Bwd Packets/s', 'Bwd Packet Length Max', 'Bwd Packet Length Min'])
...
while True:
    ...
    try:
        ...
        # Save the input values to the attack CSV file
        with open(attack_csv_path, 'a', newline='') as attack_file:
            writer = csv.writer(attack_file)
